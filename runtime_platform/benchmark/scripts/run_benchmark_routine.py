...
Usage::
    ...
    python3 runtime_platform/benchmark/scripts/run_benchmark_routine.py --mode smoke \\
    ...
    python3 runtime_platform/benchmark/scripts/run_benchmark_routine.py --mode comprehensive \\
        --evidence-issue 420 --model-id claude-opus-5

    python3 runtime_platform/benchmark/scripts/run_benchmark_routine.py --mode auth-check \\
        --evidence-issue 420
"""
...
def run_benchmark_mode(args: argparse.Namespace) -> int:
    ...
    for case_id, corpus_dir in invocations:
        ...
        proc = subprocess.run(
            [sys.executable, str(REPO_ROOT / "runtime_platform" / "benchmark" / "scripts" / "run_benchmark.py"), *argv],
            capture_output=True,
            text=True,
        )
