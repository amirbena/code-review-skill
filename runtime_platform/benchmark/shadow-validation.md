...
prose:
[`reference/benchmark_shadow_validation.py`](reference/benchmark_shadow_validation.py).
...
[`benchmark_shadow_validation.evaluate_sample`](reference/benchmark_shadow_validation.py)
...
[`scripts/shadow_validate.py`](scripts/shadow_validate.py),
