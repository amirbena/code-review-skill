...
``runtime_platform/benchmark/duplicate-noise.md``: over a case's *produced* findings
...
matcher ``runtime_platform/benchmark/reference/benchmark_match.py`` (``bm.match_pair``) applied
