...
``runtime_platform/benchmark/severity-accuracy.md``: over the matched set produced by
...
``runtime_platform/benchmark/reference/benchmark_metrics.py`` (#55), which itself delegates
every pairwise decision to the single reference matcher
``runtime_platform/benchmark/reference/benchmark_match.py`` (#54). This module therefore
