...
Contract: runtime_platform/benchmark/shadow-validation.md (Issue #335).
"""
...
class BurnInSample:
    ...
    runtime_platform/benchmark/shadow-validation.md §1 describes.
...
class BurnInAggregate:
    ...
    established (runtime_platform/benchmark/selection.md §3.3)."""
...
def aggregate_burn_in(samples: Sequence[BurnInSample]) -> BurnInAggregate:
    ...
    level figures runtime_platform/benchmark/shadow-validation.md §2/§3 define.
    ...
    (runtime_platform/benchmark/drift-detection-and-regression-lifecycle.md §3/§4.3).
...
def build_burn_in_report(aggregate: BurnInAggregate, *, window_description: str) -> dict[str, Any]:
    ...
    runtime_platform/benchmark/shadow-validation.md §5 describes: the figures alone,
