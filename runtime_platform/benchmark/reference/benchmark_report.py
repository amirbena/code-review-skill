...
``runtime_platform/benchmark/regression-report.md``: the baseline result artifact, the
...
(``runtime_platform/benchmark/reference/benchmark_runner.py``, Issue #52) verbatim and never
...
class ReportError(RuntimeError):
    ...
    ``runtime_platform/benchmark/regression-report.md`` §9: an unparseable artifact or
