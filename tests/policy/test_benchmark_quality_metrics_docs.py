...
REFERENCE = REPO_ROOT / "tests" / "reference" / "benchmark_metrics.py"
UNIT_TEST = REPO_ROOT / "tests" / "unit" / "test_benchmark_metrics.py"
...
class QualityMetricsContractTests(unittest.TestCase):
    ...
    def test_worked_examples_are_the_conformance_bar(self) -> None:
        ...
        self.assertIn("](../../tests/unit/test_benchmark_metrics.py)", self.raw)
    ...
    def test_status_defers_to_an_eventual_canonical_home(self) -> None:
        ...
        self.assertIn("](../../tests/reference/benchmark_metrics.py)", self.raw)
        self.assertIn("](../../tests/unit/test_benchmark_metrics.py)", self.raw)
