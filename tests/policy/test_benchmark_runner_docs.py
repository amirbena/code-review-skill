...
REFERENCE = REPO_ROOT / "tests" / "reference" / "benchmark_runner.py"
UNIT_TEST = REPO_ROOT / "tests" / "unit" / "test_benchmark_runner.py"
...
class RunnerContractTests(unittest.TestCase):
    ...
    def test_status_defers_to_an_eventual_canonical_home(self) -> None:
        ...
        self.assertIn("](../../tests/reference/benchmark_runner.py)", self.raw)
        self.assertIn("](../../tests/unit/test_benchmark_runner.py)", self.raw)
