...
REFERENCE = REPO_ROOT / "tests" / "reference" / "benchmark_dupes.py"
UNIT_TEST = REPO_ROOT / "tests" / "unit" / "test_benchmark_dupes.py"
...
class DuplicateNoiseContractTests(unittest.TestCase):
    ...
    def test_worked_examples_are_the_conformance_bar(self) -> None:
        ...
        self.assertIn("](../../tests/unit/test_benchmark_dupes.py)", self.raw)
    ...
    def test_status_defers_to_an_eventual_canonical_home(self) -> None:
        ...
        self.assertIn("](../../tests/reference/benchmark_dupes.py)", self.raw)
        self.assertIn("](../../tests/unit/test_benchmark_dupes.py)", self.raw)
...
class DirectoryNavigationTests(unittest.TestCase):
    ...
    def test_unit_test_consumes_the_single_reference_matcher(self) -> None:
        ...
        self.assertIn("from tests.reference import benchmark_dupes as bdup", raw)
