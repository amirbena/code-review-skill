...
reasoning" (its per-dimension bounded expansion), "Existing behavior
ownership," "Failure state, retry safety, and recovery," and "Architectural
placement and execution-lifecycle fidelity" (its bounded
caller/callee/owning-boundary context expansion), and in its two extracted
sub-policies —
