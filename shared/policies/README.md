...
| [`architectural-placement.md`](architectural-placement.md) | Whether changed code is correctly placed within the surrounding execution lifecycle: the semantic-risk trigger vocabulary, bounded ring-by-ring context expansion, stop conditions, and the evidence requirement for a placement finding. |
