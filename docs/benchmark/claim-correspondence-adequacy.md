...
[`quality-duplicated-branch-logic`](corpus/quality-duplicated-branch-logic.yaml),
[`security-command-injection`](corpus/security-command-injection.yaml) — as
...
```text
python3 scripts/benchmark/run_benchmark.py --case-id <id> --cli claude
```
...
`scripts/benchmark/benchmark_review_adapter.py::parse_review_output` has no
...
```bash
python3 scripts/benchmark/run_benchmark.py --case-id correctness-off-by-one-pagination --cli claude
python3 scripts/benchmark/run_benchmark.py --case-id security-command-injection --cli claude
python3 scripts/benchmark/run_benchmark.py --case-id quality-duplicated-branch-logic --cli claude
```
