...
| `docs/benchmark/fixture-format.md` | 438 | keep | Canonical benchmark schema with worked examples; `tests/policy/benchmark/test_benchmark_fixture_docs.py` asserts its sections. Keep. |
