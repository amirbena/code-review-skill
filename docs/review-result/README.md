...
archive, and no packaged Skill resource depends on them. `github-pr-review` can emit a
review result on explicit request ([#70](https://github.com/amirbena/code-review-skill/issues/70),
