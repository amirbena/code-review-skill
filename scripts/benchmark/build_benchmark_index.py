...
taxonomy (Issue #333). Contract: docs/benchmark/taxonomy.md §5.
...
Usage::
    ...
    python3 scripts/benchmark/build_benchmark_index.py
    python3 scripts/benchmark/build_benchmark_index.py --check
    python3 scripts/benchmark/build_benchmark_index.py --corpus-dir path/to/corpus
...
from tests.reference.benchmark import benchmark_fixture as bf  # noqa: E402
from tests.reference.benchmark import benchmark_taxonomy as tax  # noqa: E402
    ...
    if args.check:
        ...
        if existing != rendered:
            sys.stderr.write(
                ...
                f"{args.corpus_dir} — run scripts/benchmark/build_benchmark_index.py "
                "to regenerate it.\n"
            )
            return 1
        return 0
