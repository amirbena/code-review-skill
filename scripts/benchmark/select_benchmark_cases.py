...
``scripts/benchmark/classify_pr_diff.py``, produced separately — this
...
``tests/reference/benchmark/benchmark_selection.py``.

Ships informational-only (docs/benchmark/selection.md §6): this script
...
Usage::
    ...
    python3 scripts/benchmark/select_benchmark_cases.py \\
...
from tests.reference.benchmark import benchmark_selection as sel  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    # Informational only (docs/benchmark/selection.md §6): insufficient
