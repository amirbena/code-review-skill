...
| [`documentation-policy.md`](documentation-policy.md) | Structure and reading experience of this repository's human-facing docs (`README.md`, `docs/`, Skill `README.md`) — user-journey ordering, progressive disclosure, no normative duplication. |
